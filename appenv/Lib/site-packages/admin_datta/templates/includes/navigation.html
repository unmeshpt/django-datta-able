      ...
      <li>
        <div class="dropdown drp-user">
          ...
          <div class="dropdown-menu dropdown-menu-right profile-notification">
            ...
            <ul class="pro-body">
              {% if request.user.is_authenticated %}
              {% comment %} <li><a href="#" class="dropdown-item"><i class="feather icon-settings"></i>
                  Settings</a></li> {% endcomment %}
              ...
              <li><a href="#" class="dropdown-item"><i class="feather icon-mail"></i> My
                  Messages</a></li>
              {% comment %} <li><a href="#" class="dropdown-item"><i class="feather icon-lock"></i> Lock
                  Screen</a></li> {% endcomment %}
              <li>
                {% if request.user.is_superuser %}
              ...
              {% else %}
              <li><a href="{% url 'login' %}" class="dropdown-item"><i class="feather icon-log-in"></i>
                Sign IN</a></li>
              {% endif %}
            </ul>
          </div>
